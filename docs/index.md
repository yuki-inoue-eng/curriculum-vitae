...
| Kubernetes | 2.5年 | - 小規模なクラスタの設計が可能<br/>- SRE チームが管理するクラスタに新規開発したマイクロサービスのリリース、 CD を構築した経験がある<br/>- helm, kustomize 両方使用した経験がある |
...
| CircleCI       | 1年   | - build, test, deploy 一連のパイプラインを構築したことがある |
...
必要な ServiceAccount の作成とロールの付与を terraform で構築したり、secret の暗号化や k8s manifest を作成するなど、リリースに必要な工程を全て担当させていただきました。
